...
#%% 
#GENERACION TERMICA
df = pd.read_csv('../BaseDatos_SDDP/raumarg.csv', encoding='cp1252', index_col=0, header=3)
...
marginalcost = df2.ffill(axis = 0)
    
marginalcost.to_csv('../BaseDatos_DispaSET/Results/FINAL_SDDP/MarginalCost.csv', header=True, index=True)
