...
#%% 
#GENERACION TERMICA
df = pd.read_csv('../BaseDatos_SDDP/rdefbus.csv', encoding='cp1252', index_col=0, header=3)
...
df2 = df3
df2 = df2.rename({'CAÑ-069':'CAN-069','MON-115':'MOT-115','THU-069':'TOH-069'}, axis=1)	
...
outputshedload.to_csv('../BaseDatos_DispaSET/Results/FINAL_SDDP/OutputShedLoad.csv', header=True, index=True)
